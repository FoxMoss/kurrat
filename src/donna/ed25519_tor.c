...
// Fox specific notes: I removed everything that breaks it from working
// standalone
...
static void ed25519_hram(hash_512bits hram, const ed25519_signature RS,
...
// Fox: I switched this out to use mbedtls
/*
...
int ed25519_donna_seckey(unsigned char *sk) {
  ...
  ret = mbedtls_ctr_drbg_random(&ctr_drbg, seed, 32);
...
int ed25519_donna_seckey_expand(unsigned char *sk,
 ...
 * bytes long. */
int ed25519_donna_scalarmult_with_group_order(unsigned char *out,
