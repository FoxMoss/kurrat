...
static void expand256_modm(bignum256modm out, const unsigned char *in,
                           size_t len) {
...
static void contract256_window4_modm(signed char r[64],
...
static void sub256_modm_batch(bignum256modm out, const bignum256modm a,
                              const bignum256modm b, size_t limbsize) {
  size_t i = 0;
